...
import { useAuth } from '../../context/AuthContext' // Adjust this import based on your auth context path
...
export default function Generate() {
  ...
  const { user } = useAuth() // Assuming you have a useAuth hook that provides user info
